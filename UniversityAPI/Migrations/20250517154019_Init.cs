    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeachersProfiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeachersProfiles_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeachersProfiles_Degrees_DegreeId",
                        column: x => x.DegreeId,
                        principalTable: "Degrees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeachersProfiles_Faculties_FacultyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TeacherGroupSubjects_TeachersProfiles_TeacherProfileId",
                        column: x => x.TeacherProfileId,
                        principalTable: "TeachersProfiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TestAnswersResults", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TestAnswersResults_StudentProfiles_StudentProfileId",
                        column: x => x.StudentProfileId,
                        principalTable: "StudentProfiles",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TestAnswersResults_Tests_TestId",
                        column: x => x.TestId,
                        principalTable: "Tests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TestAnswers_TestAnswersResults_TestResultId",
                        column: x => x.TestResultId,
                        principalTable: "TestAnswersResults",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "TeachersProfiles",
                column: "DegreeId");

            migrationBuilder.CreateIndex(
                name: "IX_TeachersProfiles_FacultyId",
                table: "TeachersProfiles",
                column: "FacultyId");

            migrationBuilder.CreateIndex(
                name: "IX_TeachersProfiles_UserId",
                table: "TeachersProfiles",
                column: "UserId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestAnswersResults_StudentProfileId",
                table: "TestAnswersResults",
                column: "StudentProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_TestAnswersResults_TestId",
                table: "TestAnswersResults",
                column: "TestId");
